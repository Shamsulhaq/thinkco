  ...
  return [
    {
      ...
      run: () => ({
        ...
        message: [
          ...
          '/status             Show repo/provider/model/mode status',
          '/turn               Show latest turn details',
          '/changes            Show changed files',
          '/provider <name>    Switch provider',
          '/provider status    Show provider/model/fallback status',
          '/skills             List available skills',
          '/plugin             List installed plugins (/plugin doctor <name>)',
